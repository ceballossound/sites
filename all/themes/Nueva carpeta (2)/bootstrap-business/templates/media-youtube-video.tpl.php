...
<div class="<?php print $classes; ?> media-youtube-<?php print $id; ?>">
  <iframe class="media-youtube-player" <?php print $api_id_attribute; ?>width="<?php print $width; ?>" height="<?php print $height; ?>" title="<?php print $title; ?>" src="<?php print $url; ?>" frameborder="1" allowfullscreen><?php print $alternative_content; ?></iframe>
